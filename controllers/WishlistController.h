...
public:
    METHOD_LIST_BEGIN
        ...
        ADD_METHOD_TO(WishlistController::addToWishlist, "/wishlist/add/{id}", Get, "LoginFilter");
        ADD_METHOD_TO(WishlistController::removeFromWishlist, "/wishlist/remove/{id}", Get, "LoginFilter");
    METHOD_LIST_END
